...
class top(gr.top_block):
   ...
   def __init__(self, consume_amount):
      ...
      self.connect((self.blocks_head_0, 0), (self.blocks_multiply_const_vxx_0, 0))
...
def time_it(tb, np_times, np_items, r):
   ...
   tb.run()
   tb.wait()
   np_times[r] = tb.blocks_multiply_const_vxx_0.pc_work_time_avg()
   np_items[r] = tb.blocks_multiply_const_vxx_0.pc_nproduced_avg()
...
if __name__ == "__main__":
   ...
   try:
      ...
      print(df)
      df.to_csv("multiply_const.csv", index=False)
